...
export const Lesson1: Lesson = {
    ...
    characters: [
        ...
        { hanzi: '没关系', pinyin: 'méi guānxi', definition: `Don't mention it.` },
        { hanzi: '再见', pinyin: 'zàijiàn', definition: 'good-bye' },
        { hanzi: '请', pinyin: 'qǐng', definition: 'please' },
        { hanzi: '进', pinyin: 'jìn', definition: 'to enter' },
        { hanzi: '坐', pinyin: 'zuò', definition: 'to sit' },
        { hanzi: '听', pinyin: 'tīng', definition: 'to listen' },
        { hanzi: '说', pinyin: 'shuō', definition: 'to say' },
